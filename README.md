...
**[Download the latest release](https://github.com/OpenPhantom/OpenPhantom/releases/tag/i1.5.0)** · [Installation guide](https://github.com/OpenPhantom/OpenPhantom/wiki/Installation-Guide) · [Discord](https://discord.gg/73UbZN2y7x)
...
**Want to play?** Download the [latest release](https://github.com/OpenPhantom/OpenPhantom/releases/tag/i1.5.0) and run the OpenPhantom installer. It installs the original game from your own disc and applies the available patches and fixes for modern Windows PCs. You don't need to build anything from source.
