 ...
 * corrected later, which would leave the ini and the world disagreeing. Kept in step with
 * view_distance_fix's own clamp by a comment at both ends, since a header cannot be shared
