 ...
 *
 * The region, the positions and the drawn footprints, with the assertions that hold them apart,
 * are in controls_layout.h, which the menu_patcher unit test reads as well. */
